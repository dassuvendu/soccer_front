...
export const Termsofservice = () => {
  return (
    <>
      <Helmet>
        <title>Playcope - Terms of service</title>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-4">
            <p>
              ...
              "us") through our website and platform offering football
              prediction services (the "Service"). By accessing or using the
          ...
          <div className="mb-4">
            ...
            <p className="pb-2">
              ...
              Service, you agree to pay the applicable subscription fees and
              abide by the terms of your chosen subscription plan. Subscription
          ...
          <div className="mb-4">
            ...
            <p className="pb-2">
              ...
              accuracy or reliability of the predictions provided. Predictions
            ...
            <p className="pb-2">
              ...
              materials provided through the Service, including but not limited
              to predictions, analysis, and data, are the property of PLAYCOPE
              LTD. and are protected by intellectual property laws. You may not
              use, reproduce, or distribute any content from the Service without
              our prior written consent.
            </p>
            <p className="pb-2">
              <strong>2.3. Prohibited Activities:</strong> You agree not to
              engage in any activities that may disrupt or interfere with the
              proper functioning of the Service, including but not limited to
              hacking, data scraping, or unauthorized access to our systems.
            </p>
          </div>
          <div className="mb-4">
            <p className="font-bold pb-2">3. Limitation of Liability</p>
            <p className="pb-2">
              <strong>3.1. Disclaimer:</strong> To the fullest extent permitted
              by law, we disclaim any warranties or representations regarding
              the accuracy, reliability, or suitability of the Service for any
              particular purpose. We shall not be liable for any direct,
            ...
            <p className="pb-2">
              ...
              damages, or losses arising out of your use of the Service or
          ...
          <div className="mb-4">
            ...
            <p className="pb-2">
              <strong>4.1. Modification of Terms:</strong> We reserve the right
            ...
            <p className="pb-2">
              ...
              by and construed in accordance with the sport laws as recognized
              by FIFA, without regard to its conflict of laws principles.
            </p>
            <p className="pb-2">
