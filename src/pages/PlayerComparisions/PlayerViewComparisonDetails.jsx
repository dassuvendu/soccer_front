...
const PlayerViewComparisonDetails = () => {
  ...
  const { playerFDetails, playerSDetails } = useSelector((state) => state.playerComparision)
      ...
      <div className="pt-6 pb-4 px-3 mb-4">
        ...
        {playerFDetails?.response?.map((ply) => (
          <div className="text-center">
            ...
            />
            <p
              className={`font-Syne text-[13px] leading-[13px] font-bold ${themeMode === "light" ? "text-black" : "text-white"
                }`}
            >
              {ply?.player?.name}
            </p>
